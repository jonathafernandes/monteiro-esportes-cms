    ...
    return (
        <>
            <div id="brand" className="bg-zinc-950 text-zinc-50 w-full flex gap-4 sm:gap-0 flex-col sm:items-start sm:w-auto sm:flex-row py-8 px-16 sm:px-8 rounded-none sm:rounded">
                ...
                <div className="flex">
                    <img src="BRAND_36766.jpeg" alt="Detalhe da luva de goleiro com a logo da Monteiro Esportes estampada." className="w-72 border-2 border-zinc-50 rounded mr-1 transition-transform transform hover:-translate-y-2" />
                    <img src="BRAND_44246.jpeg" alt="Jogador de futebol com uniforme segurando uma bola." className="w-72 border-2 border-zinc-50 rounded mr-1 hidden lg:block transition-transform transform hover:-translate-y-2" />
                    <img src="BRAND_442465.jpeg" alt="Atleta de futebol em traje verde e preto aponta para cima." className="w-72 border-2 border-zinc-50 rounded hidden xl:block transition-transform transform hover:-translate-y-2" />
                </div>
            </div>
            <br />
            <br />
